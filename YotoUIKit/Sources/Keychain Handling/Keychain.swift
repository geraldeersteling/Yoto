...
public struct Keychain {
    public static func store(_ item: Data, withAttributes attributes: KeychainAttributes) throws {
    ...
    public static func retrieveItem(forAttributes attributes: KeychainAttributes) throws -> Data? {
        var query = attributes.query
    ...
    public static func deleteItem(withAttributes attributes: KeychainAttributes) throws {
